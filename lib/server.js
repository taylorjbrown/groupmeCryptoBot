    ...
    static postResponse() {
        ...
        if (messageResponse) {
            Bot.cryptoGet(messageResponse,function(result){
                ...
                var sendInfo = "TimeStamp: " + timeStamp +"\n"
                + "Ticker: "+ messageResponse +"\n"
                + "Price: "+ result['DISPLAY'][messageResponse]['USD']['PRICE'] +"\n"
                + "LastMarket: " + result['DISPLAY'][messageResponse]['USD']['LASTMARKET'] + "\n"
                + "24 Hour High: " + result['DISPLAY'][messageResponse]['USD']['HIGH24HOUR']+ "\n"
                + "24 Hour Low: " + result['DISPLAY'][messageResponse]['USD']['LOW24HOUR'];
